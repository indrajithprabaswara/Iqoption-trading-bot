    ...
    if not os.path.exists(file_path):
        with open(file_path, "w", newline="") as f:
            ...
            writer.writerow([
                ...
                "EMAShort", "EMALong", "EMARatio", "PriceChange"
            ])
    ...
    if not os.path.exists(file_path):
        with open(file_path, "w", newline="") as f:
            ...
            writer.writerow([
                ...
                "NewsSentiment", "EMAShort", "EMALong", "EMARatio", "PriceChange"
            ])

def log_trade(file_path, row):                      
    with open(file_path, "a", newline="") as f:
        writer = csv.writer(f)
        expected_columns = 31  # Number of expected columns
...
def log_full_history(file_path, row):
    with open(file_path, "a", newline="") as f:
        writer = csv.writer(f)
        expected_columns = 24  # Number of expected columns for full_history_log.csv
        ...
        while True:
            try:
                ...
                log_full_history(FULL_HISTORY_LOG_FILE, [
                    ...
                    ema_short, ema_long, ema_ratio, price_change
                ])
