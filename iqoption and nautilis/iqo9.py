...
def main():
    ...
    try:
        ...
        # --- FIX: Main Persistent Loop for Continuous Logging and Periodic Trading ---
        while main_loop_active:
            ...
            # 2. Trade Execution Logic (Triggered periodically after TRADING_ITERATIONS is met)
            ...
            if trade_attempt_count >= TRADING_ITERATIONS:
                ...
                # The loop will continue, but the trade block will no longer be entered.
